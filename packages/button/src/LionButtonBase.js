...
/**
 * Use LionButton (or LionButtonBase|LionButtonReset) when there is a need to extend HTMLButtonElement.
 ...
 *
 * Note that LionButtonBase is meant for buttons with type="button". It's cleaner and more
 * lightweight than LionButtonReset and LionButton, which should only be considered when native
 * `<form>` support is needed:
 * - When type="reset|submit" should be supported, use LionButtonReset.
 * - When implicit form submission should be supported on top, use LionButton.
 */
export class LionButtonBase extends DisabledWithTabIndexMixin(LitElement) {
